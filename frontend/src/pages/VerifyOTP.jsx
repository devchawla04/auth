      ...
      <div className='flex-1 flex items-center justify-center p-4'>
        <div className='w-full max-w-md space-y-6'>
          <div className='text-center space-y-2'>
            <h1 className='text-3xl font-bold tracking-tight text-blue-600'>Verify your email</h1>
          ...
          <Card className='shadow-lg'>
            <CardHeader className='space-y-1'>
              <CardTitle className='text-2xl text-center text-blue-600'>Enter verification code</CardTitle>
            ...
            <CardContent className='space-y-6'>
              ...
              {successMessage && <p className='text-blue-600 text-sm mb-3 text-center'>{successMessage}</p>}
              {
                isVerified ? (
            ...
            <CardFooter className='flex justify-center'>
              <p className='text-sm text-muted-foreground'>
                Wrong email?{" "}
                <Link to={'/forgot-password'} className='text-blue-600 hover:underline font-medium'>Go back</Link>
              </p>
            </CardFooter>
          </Card>
